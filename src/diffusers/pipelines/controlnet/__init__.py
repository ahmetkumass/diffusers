...
try:
    ...
    _import_structure["stable_diffusion_control_brush_pipeline"] = ["StableDiffusionControlNetBrushNetPipeline"] ###
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .stable_diffusion_control_brush_pipeline import StableDiffusionControlNetBrushNetPipeline ###
